                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center" style="padding-bottom:10px!important;">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('Cindy - Waiting For Return') }}</h3>
                            </div>
                                        ...
                                        <td class="text-right prodtd">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                    
                                                        ...
                                                        @else
                                                        <form action="/autofulfillDeleteReturn/{{$route}}/{{$return->id}}" method="post">
                                                        @endif
                                                            ...
                                                            @else
                                                            <a class="dropdown-item" href="/autofulfillLabelDelete/{{$route}}/{{$return->id}}">{{ __('Delete Label') }}</a>
                                                            @endif

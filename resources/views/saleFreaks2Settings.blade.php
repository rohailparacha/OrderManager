...
@section('content')
    @include('users.partials.header', ['title' => __('SaleFreaks2 - Order Fulfillment Settings')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="/saleFreaks2StoreSettings" autocomplete="off" id="target">
                            @csrf
                            
                            <div class="row" style="padding-right:3%;">
                                <div class="col-md-6">
                                <h3 class=" text-muted mb-4">{{ __('SaleFreaks2 - Settings') }}</h3>
                                </div>
                                <div class="col-md-6">

...
$(document).ready(function(){
        ...
        bceurl = link.data("bceurl"),
        accountType = link.data("type");
        var acc = 2; 
        ...
        $('#emailTbx').val(email);
        $('#accountTypeTbx').val(acc);
        $('#bceurlTbx').val(bceurl);
        $('#addTitle').hide();
        $('#modal-que-save').hide();  
        $('#editTitle').show();
        $('#modal-que-edit').show();  
        ...
        $('#modal-que-save').on('click',function(event){ 
            ...
            var type = $('#accountTypeTbx option:selected').val();
            var bceurl = $('#bceurlTbx').val();
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Gmail Integration') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <input type="button" id="btnAddCat" class="btn btn-sm btn-primary" value="Add Gmail Account"/>                                    
                            </div>    
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                    
                                                        <form action="{{ route('gmailAccountDelete', $account->id) }}" method="post">
                                                            @csrf
                                                            @method('delete')                                                                                                                                                         
                                                            <a class="dropdown-item"  data-toggle="modal" data-target="#addCat" data-type={{$account->accountType}} data-email="{{$account->email}}" data-name="{{$account->url}}"  data-bceurl="{{$account->bceurl}}" data-id="{{$account->id}}" id="btnEditCat" href="#">{{ __('Edit') }}</a>
...
<div class="row clearfix">
       <div class="col-sm-3 form-control-label">
           <label for="email_address_2">@lang('Email Address:')</label>
       </div>
       <div class="col-sm-9">
           <div class="form-group">
               <div class="form-line">
                   <div class="form-line">
                       <input type="email" class="form-control" id="emailTbx" name="category" required>                                        
                   </div>
...
<div class="row clearfix">
       <div class="col-sm-3 form-control-label">
           <label for="email_address_2">@lang('Gmail Account URL:')</label>
       </div>
       <div class="col-sm-9">
           <div class="form-group">
               <div class="form-line">
                   <div class="form-line">
                       <input type="text" class="form-control" id="categoryTbx" name="category" required>                                        
                   </div>
                    <div class="errorMsg">{!!$errors->survey_question->first('category');!!}</div>
               </div>
           </div>
...
<div class="row clearfix">
       <div class="col-sm-3 form-control-label">
           <label for="email_address_2">@lang('BCE Forwarder URL:')</label>
       </div>
       <div class="col-sm-9">
           <div class="form-group">
               <div class="form-line">
                   <div class="form-line">
                       <input type="text" class="form-control" id="bceurlTbx" name="category" required>                                        
                   </div>                    
               </div>
           </div>
       </div>
...
<div class="row clearfix">
       <div class="col-sm-3 form-control-label">
           <label for="email_address_2">@lang('Account Type:')</label>
       </div>
       <div class="col-sm-9">
           <div class="form-group">
               <div class="form-line">
                   <div class="form-line">
                    <select class="form-control" id="accountTypeTbx" style="">                                

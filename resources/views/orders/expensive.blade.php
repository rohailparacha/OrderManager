                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h3 class="mb-0">{{ __('New Orders - Expensive') }}</h3>
                            </div>  
                    ...
                    <div class="col-12">
                        ...
                        <form action="orderFilterExpensive" class="navbar-search navbar-search-light form-inline" style="width:100%" method="post">
                            @csrf

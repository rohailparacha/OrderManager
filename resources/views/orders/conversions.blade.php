                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h3 class="mb-0">{{ __('BCE Conversions') }}<span  style="font-size:14px; color:red; padding-left:5px;">Remaining Credits : {{$credits}}</span></h3>                                
                            </div>  
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('New Tracking Number') }}</th>
                                    <th scope="col">{{ __('Tracking URL') }}</th>
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>                                        
                                        ...
                                        <td><a target="_blank" href="https://bluecare.express/Tracking?trackingReference={{ $order->newTrackingNumber }}">https://bluecare.express/Tracking?trackingReference={{ $order->newTrackingNumber }}</a></td>

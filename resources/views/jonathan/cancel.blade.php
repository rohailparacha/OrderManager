                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                            <h3 class="mb-0">{{ __('Jonathan - Cancel Pending') }}</h3>                             
                            </div>  
                            <div class="col-6" style="text-align:right;">
                            <a href="jonathanOrderCancelledExport" class="btn btn-primary btn-md" style="color:white;float:right;margin-left:30px;">Export</a>       
                                        ...
                                        <td class="text-right prodtd">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                                                                            
                                                        <form action="{{ route('jonathanDeleteCancelled', $order->cancelledId) }}" method="post">
                                                            @csrf
                                                            @method('delete')                                                                                                                                                           

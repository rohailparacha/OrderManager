                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center" style="padding-bottom:10px!important;">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('Jonathan2 - Waiting For Return') }}</h3>
                            </div>
                                        ...
                                        <td class="text-right prodtd">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                    
                                                        @if(empty($route))                               
                                                        <form action="{{ route('jonathan2DeleteReturn', $return->id) }}" method="post">
                                                        @else
                                                        <form action="/jonathan2DeleteReturn/{{$route}}/{{$return->id}}" method="post">
                                                        @endif
                                                            @csrf
                                                            @method('delete')                                                                                                                                                         
                                                            ...
                                                            @if(empty($route))
                                                            <a class="dropdown-item" href="/jonathan2LabelDelete/{{$return->id}}">{{ __('Delete Label') }}</a>
                                                            @else
                                                            <a class="dropdown-item" href="/jonathan2LabelDelete/{{$route}}/{{$return->id}}">{{ __('Delete Label') }}</a>
                                                            @endif

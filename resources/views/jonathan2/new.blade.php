...
var url = "/jonathan2export?" + $.param(query)
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h3 class="mb-0">{{ __('Jonathan2 - Auto Fulfill Orders') }}</h3>
                            </div>  
                            ...
                            <div class="col-6" style="text-align:right;">
                                ...
                                <a href="jonathan2Process" class="btn btn-primary btn-md">Process Orders</a>
                                 @endif
                            </div>                      
                    ...
                    <div class="col-12">
                        ...
                        <form action="jonathan2Filter" class="navbar-search navbar-search-light form-inline" style="width:100%" method="post">
                            @csrf

...
var url = "/transactionexport?" + $.param(query)
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('Accounting - Pending Transactions') }}</h3>
                            </div>
                            <div class="col-8" style="float:right; ">
                            <form class="form-inline" action="/transactionsUpload" method="post" enctype="multipart/form-data" style="float:right;">
                            {{ csrf_field() }}
                                <div class="form-group">

                                    <select class="form-control" id="bankTbx" name="bankTbx" style="margin-right:10px;">                                
                                    ...
                                    <a id="assign" style="color:white;" class="btn btn-md btn-primary">{{ __('Assign Category') }}</a>       
                    ...
                    <div class="row" style="margin-left:0px!important;">
                        ...
                        <form action="transactionFilter" class="navbar-search navbar-search-light form-inline" style="width:100%" method="post">
                            @csrf
                            ...
                            <div style="padding-right:1%;">
                                <select class="form-control" name="bankFilter" style="margin-right:0%;width:180px;">
                                    ...
                                    <a href="./transactionstemplate" class="btn btn-primary btn-md" style="color:white;text-align:right;">Template File</a>                              

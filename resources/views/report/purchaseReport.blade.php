@extends('layouts.app', ['title' => __('Purchase Report')])
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h3 class="mb-0">{{ __('Purchase Report') }}</h3>
                        </div>
                    </div>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('purchase.report') }}" class="form-inline" style="width:100%" method="get">
                    ...
                    <div class="row">
                        <div class="col float-left">
                            <h3>@if($chartType == 'amt') Purchase Amount Chart @else Purchase Quantity Chart @endif</h3>

...
$(document).ready(function(){
        ...
        $('#modal-que-save').on('click',function(event){ 
            ...
            var def = $('#defaultTbx').prop( "checked");
            var breakeven = $('#breakevenTbx').val();
            $.ajax({
                
            type: 'post',
            url: '/ebay/addStrategy',
            data: {
            'code': code,
            'type': type,
            'value': value,
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Ebay Strategies') }}</h3>
                            </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                    
                                                        <form action="{{ route('ebayStrategyDelete', $strategy->id) }}" method="post">
                                                            @csrf
                                                            @method('delete')                                                                                                                                                         
                                                            <a class="dropdown-item"  data-toggle="modal" data-target="#addCat" data-code="{{$strategy->code}}" data-id="{{$strategy->id}}"  data-default ="{{$strategy->isDefault}}"   data-breakeven="{{$strategy->breakeven}}"  data-val="{{$strategy->value}}"  data-type="{{$strategy->type}}"   id="btnEditCat" href="#">{{ __('Edit') }}</a>
...
<div class="row clearfix">
       <div class="col-sm-3 form-control-label">
           <label for="email_address_2">@lang('Is Default:')</label>
       </div>
       <div class="col-sm-9">
           <div class="form-group">
               <div class="form-line">
                   <div class="row form-line" style="padding-left: 15px;padding-right: 15px;">
                        <input type="checkbox" name="default" id="defaultTbx">
                   </div>

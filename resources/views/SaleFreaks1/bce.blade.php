                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h3 class="mb-0">{{ __('SaleFreaks1 - BCE Pending') }}</h3>                                
                            </div>  
                            <div class="col-6" style="text-align:right;">
                            <a href="saleFreaks1OrderFulfillmentExport" class="btn btn-primary btn-md" style="color:white;float:right;margin-left:30px;">Export</a>       
                                        ...
                                        <button class="btnProcess btn btn-primary btn-sm" style="float:left;" data-id="{{$order->id}}"> Add BCE Tracking</button>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                                                                            
                                                        <form action="{{ route('saleFreaks1DeleteConversion', $order->id) }}" method="post">
                                                            @csrf
                                                            @method('delete')                                                                                                                                                           

...
var url = "/saleFreaks1export?" + $.param(query)
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('SaleFreaks1 - Auto Fulfill Orders') }}</h3>
                            </div>  
                            ...
                            <div class="col-4" style="text-align:right;">
                                ...
                                <a href="saleFreaks1OrderExport" class="btn btn-primary btn-md">Export SaleFreaks1 Orders</a>                                                        
                                
                                 @endif
                            </div>                      
                            <div class="col-4" style="float:right; ">
                                <form class="form-inline" action="/saleFreaks1Process" method="post" enctype="multipart/form-data" style="float:right;">
                                {{ csrf_field() }}
                    ...
                    <div class="col-12">
                        ...
                        <form action="saleFreaks1Filter" class="navbar-search navbar-search-light form-inline" style="width:100%" method="post">
                            @csrf

                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <h3 class="mb-0">{{ __('Yaballe - Waiting For Refund') }}</h3>
                            </div>
                                        ...
                                        <td class="text-right prodtd">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                    
                                                        @if(empty($route))                               
                                                        <form action="{{ route('yaballeDeleteReturn', $return->id) }}" method="post">
                                                        @else
                                                        <form action="/yaballeDeleteReturn/{{$route}}/{{$return->id}}" method="post">
                                                        @endif
                                                            @csrf
                                                            @method('delete')                                                                                                                                                         
                                                            ...
                                                            @if(empty($route))
                                                            <a class="dropdown-item" href="/yaballeLabelDelete/{{$return->id}}">{{ __('Delete Label') }}</a>
                                                            @else
                                                            <a class="dropdown-item" href="/yaballeLabelDelete/{{$route}}/{{$return->id}}">{{ __('Delete Label') }}</a>
                                                            @endif

...
class yaballeReturnsController extends Controller
{
    //
    public function index()
    {
            if(auth()->user()->role==1)
            {
                ...
                ->where('orders.account_id','Yaballe')
            ...
            $dateRange = $from .' - ' .$to;
            return view('yaballe.return',compact('returns','accounts','stores','dateRange'));
    }
    public function refunds()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('yaballe.refund',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function completed()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('yaballe.complete',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function returnFilter(Request $request)
    {
        ...
        if($request->has('storeFilter'))
            ...
            return view('yaballe.return',compact('returns','accounts','stores','statusFilter','labelFilter','storeFilter','accountFilter','dateRange'));

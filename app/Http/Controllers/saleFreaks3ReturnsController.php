...
class saleFreaks3ReturnsController extends Controller
{
    //
    public function index()
    {
            if(auth()->user()->role==1)
            {
                ...
                ->where('orders.account_id','SaleFreaks3')
            ...
            $dateRange = $from .' - ' .$to;
            return view('SaleFreaks3.return',compact('returns','accounts','stores','dateRange'));
    }
    public function refunds()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('SaleFreaks3.refund',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function completed()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('SaleFreaks3.complete',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function returnFilter(Request $request)
    {
        ...
        if($request->has('storeFilter'))
            ...
            return view('SaleFreaks3.return',compact('returns','accounts','stores','statusFilter','labelFilter','storeFilter','accountFilter','dateRange'));

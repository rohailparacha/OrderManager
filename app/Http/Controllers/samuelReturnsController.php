...
class samuelReturnsController extends Controller
{
    //
    public function index()
    {
            if(auth()->user()->role==1)
            {
                ...
                ->where('orders.account_id','Samuel')
            ...
            $dateRange = $from .' - ' .$to;
            return view('samuel.return',compact('returns','accounts','stores','dateRange'));
    }
    public function refunds()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('samuel.refund',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function completed()
    {
            ...
            $to = date("m/d/Y", strtotime($endDate));  
            $dateRange = $from .' - ' .$to;
            return view('samuel.complete',compact('returns','accounts','stores','dateRange'));
    }
    ...
    public function returnFilter(Request $request)
    {
        ...
        if($request->has('storeFilter'))
            ...
            return view('samuel.return',compact('returns','accounts','stores','statusFilter','labelFilter','storeFilter','accountFilter','dateRange'));

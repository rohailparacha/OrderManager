...
class ProcessedTransactionsExport implements FromCollection,WithHeadings,ShouldAutoSize
{
    /**
    ...
    */
    ...
    {        
       ...
       if(!empty($startDate)&& !empty($endDate))
       {
        ...
        $transactions = $transactions->whereNotNull('transactions.category_id')->get();
